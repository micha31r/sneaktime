...
sound_effects = {
	...
	"click": pg.mixer.Sound(os.path.join(*[rs_dir, 'sounds', 'click.wav'])),
	"confirm": pg.mixer.Sound(os.path.join(*[rs_dir, 'sounds', 'confirm.wav'])),
	"fail": pg.mixer.Sound(os.path.join(*[rs_dir, 'sounds', 'fail.wav'])),
	"footstep": pg.mixer.Sound(os.path.join(*[rs_dir, 'sounds', 'footstep.wav'])),
	"impact": pg.mixer.Sound(os.path.join(*[rs_dir, 'sounds', 'impact.wav'])),
	"laser": pg.mixer.Sound(os.path.join(*[rs_dir, 'sounds', 'laser.wav'])),
	"pickup_item": pg.mixer.Sound(os.path.join(*[rs_dir, 'sounds', 'pickup_item.wav'])),
	...
	"success": pg.mixer.Sound(os.path.join(*[rs_dir, 'sounds', 'success.wav'])),
